...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<StudentDTO> createNewStudent(@RequestBody AddStudentDto addnewStudentDto,  HttpServletRequest request){
        System.out.print("addnewStudentDto " + addnewStudentDto);
